...
# Cloudflare Turnstile integration with Plone build configuration file
...
project = "Cloudflare Turnstile integration with Plone"
...
linkcheck_ignore = [
    ...
    r"https://github.com/collective/collective.volto.turnstile/issues/new",  # requires auth  ## noqa: E501
...
html_theme_options = {
    ...
    "icon_links": [
        {
            "name": "GitHub",
            "url": "https://github.com/collective/collective.volto.turnstile",
    ...
    "logo": {
        "text": "Cloudflare Turnstile integration with Plone",
    },
    "navigation_with_keys": True,
    "path_to_docs": "docs/docs",
    "repository_branch": "main",
    "repository_url": "https://github.com/collective/collective.volto.turnstile",
...
# html_context = {
#     "edit_page_url_template": "https://github.com/collective/collective.volto.turnstile/edit/main/docs/",
# }

# Announce that we have an opensearch plugin
# https://www.sphinx-doc.org/en/master/usage/configuration.html#confval-html_use_opensearch
html_use_opensearch = "https://collectivevoltoturnstile.readthedocs.io"
...
html_baseurl = "https://collectivevoltoturnstile.readthedocs.io/en/latest/"
...
ogp_site_url = "https://collectivevoltoturnstile.readthedocs.io/en/latest/"
ogp_description_length = 200
ogp_image = "https://collectivevoltoturnstile.readthedocs.io/en/latest/_static/logo.svg"
ogp_site_name = "Cloudflare Turnstile integration with Plone Documentation"
ogp_type = "website"
...
htmlhelp_basename = "Cloudflare_Turnstile_integration_with_Plone_Documentation"
...
latex_documents = [
    (
        "index",
        "Cloudflare_Turnstile_integration_with_Plone_Documentation.tex",
