...
i18n: $(VENV_FOLDER) ## Update locales
	...
	@$(BIN_FOLDER)/python -m collective.volto.turnstile.locales
...
test-coverage: $(VENV_FOLDER) ## run tests with coverage
	@$(BIN_FOLDER)/pytest --cov=collective.volto.turnstile --cov-report term-missing
